...
window['Rainbow'] = (function() {
  ...
  function _highlightCodeBlock(code_blocks, i, onComplete) {
    if (!inHighlight) inHighlight = true;
  ...
  return {
    /**
     * convert space seperated list of words to regex based string for keyword searching
     *
     * @param  {String} str Space seperated words for matching
     * @return {String}     Regex string to be used with RegExp method
     */
    ...
    /**
     * Implement method to allow for callback after highlighting has been called.
     * @param  {Function} callback
